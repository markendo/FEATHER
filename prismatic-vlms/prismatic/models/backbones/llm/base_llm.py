        ...
        # [Contract] `inference_mode` means we're loading from a pretrained checkpoint; no need to load base weights!
            ...
            if fastv:
                if fastv_k is not None:
                    llm_config.fastv_k = fastv_k
                if fastv_ratio is not None:
                    llm_config.fastv_ratio = fastv_ratio
                if fastv_predefined_mask is not None:
                    llm_config.fastv_predefined_mask = fastv_predefined_mask
