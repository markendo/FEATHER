...
from prismatic.models.backbones.llm.llama2_models import FastVLlamaForCausalLM
...
LLAMA2_MODELS = {
    ...
    "llama2-7b-fastv-pure": {
        "llm_family": "llama2", "llm_cls": FastVLlamaForCausalLM, "hf_hub_path": "meta-llama/Llama-2-7b-hf"
    },
    ...
    "llama2-7b-dvt-inference-fastv-pure": {
        "llm_family": "llama2", "llm_cls": FastVLlamaForCausalLM, "hf_hub_path": "meta-llama/Llama-2-7b-hf"
    },
...
class LLaMa2LLMBackbone(HFCausalLLMBackbone):
    def __init__(
        ...
        fastv_ratio: Optional[float] = None,
